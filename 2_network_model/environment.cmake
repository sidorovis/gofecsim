...
option( BOOST_STATIC "boost was compiled with static link" OFF )
option( COPY_CONFIG_FILES "should we copy configuration files with copy_config_file macro" ON )
option( BOOST_HEADER_ONLY "boost will be compiled with header only dependency" OFF)
...
if ( UNIX )
	if (Debug)
                add_definitions( " -O0 -g -Wall -std=c++0x -pedantic -pedantic-errors -W -pthread " )
	else()
                add_definitions( " -O3 -Wall -Werror -std=c++0x -pedantic -pedantic-errors -W -pthread " )
	endif()
        set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -pthread")
        add_definitions( -DWEBRTC_POSIX )
	set(output_path ${PROJECT_BINARY_DIR}/bin_${CMAKE_ADDRESS_MODEL}/${CMAKE_BUILD_TYPE})
	if ( ${VERBOSE} )
		message(STATUS " -T: Unix definitions were installed")
	endif( ${VERBOSE} )
elseif( WIN32 )
	...
	if ( ${VERBOSE} )
		message(STATUS " -T: Win32 definitions were installed")
	endif( ${VERBOSE} )
endif( UNIX )
...
if (ANDROID)
	...
	if ( ${VERBOSE} )
		message(STATUS " -T: Android definitions were installed")
	endif( ${VERBOSE} )
endif(ANDROID)
